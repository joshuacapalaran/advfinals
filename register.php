<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        } elseif (!preg_match("/^[a-zA-Z0-9]{0,10}$/", trim($_POST['username']))) {
              $usernameErr = 'Username should have 10 characters only';
        } elseif (!preg_match("/^[a-zA-Z0-9]{10}$/", trim($_POST['username']))) {
                  $usernameErr = 'Username should be in alphanumeric character';
        } else {
